...
use Reliv\Git\Command\CommitCommand;
...
class CommitCommandTest extends UnitBase
{
    /** @var \Reliv\Git\Command\CommitCommand */
    protected $command;
     ...
     * @return void
     *
     * @covers \Reliv\Git\Command\CommitCommand
     */
    public function testConstructor()
    {
        $this->assertTrue($this->command instanceof CommitCommand);
